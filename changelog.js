...
export const CHANGELOG = [
  ...
  { v:'1.44.1', date:'2026-09-01', notes:[
    ...
    'Salabota kļūda, kad atkārtota "Saglabāt aktuālo mēnesi → arhīvā" nospiešana katru reizi izveidoja jaunu, tālāku mēnesi (piem., Septembris → Oktobris → Novembris) tā vietā, lai pārrakstītu to pašu ierakstu',
  ], notesEn:[
    ...
    'Fixed a bug where pressing "Save current month to archive" repeatedly created a new, later month each time (e.g. September → October → November) instead of overwriting the same entry',
  ]},
