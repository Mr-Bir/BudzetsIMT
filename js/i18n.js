...
const STRINGS = {
  lv: {
    ...
    'new_month.type_confirm_label': 'Lai apstiprinātu, ieraksti {{label}}:',
    ...
    'archive.restore': 'Atjaunot',
    'archive.restore_title': 'Aizstāt aktuālo mēnesi ar šiem datiem',
    'archive.confirm_restore': 'Aizstāt aktuālo mēnesi ("{{current}}") ar arhivētajiem datiem no "{{label}}"? Pašreizējie rēķini, kredīti, ienākums un papildu ienākumi tiks PĀRRAKSTĪTI. To nevar atsaukt.',
    'archive.restore_done': '"{{label}}" atjaunots aktuālajā mēnesī ✓',
    ...
    'archive_modal.paid_date_title': 'Samaksas datums',
  ...
  en: {
    ...
    'new_month.type_confirm_label': 'To confirm, type {{label}}:',
    ...
    'archive.restore_title': 'Replace the current month with this data',
    'archive.confirm_restore': 'Replace the current month ("{{current}}") with the archived data from "{{label}}"? Current bills, credits, income, and extra income will be OVERWRITTEN. This cannot be undone.',
    'archive.restore_done': '"{{label}}" restored into the current month ✓',
    ...
    'archive_modal.paid_date_title': 'Payment date',
